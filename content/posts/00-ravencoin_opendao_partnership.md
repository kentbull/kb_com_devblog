+++
title = "Announcing: Ravencoin and OpenDAO Partnership"
slug = "ravencoin-opendao"
date = "2021-03-04"

[taxonomies]
tags=["announcement", "ravencoin"]
...
{% image(path="/images/posts/00-ravencoin-opendao.jpeg", class="full-width",
    op="fit_width",
    alt="Ravencoin and OpenDAO Partnership") 
    %}
Ravencoin and OpenDAO Partnership
{% end %}
...
[OpenDAO](https://opendao.io_) (OPEN) acts as a bridge for bringing various asset classes into the DeFi ecosystem while leveraging the liquidity of multiple cryptocurrencies through providing dollar-pegged stable coins for each cryptocurrency. The work with Ravencoin creates $RAVEN0 as one of these dollar-pegged stable coins.
...
> 
> OpenDAO team at opendao.io/dao
...
Read [here](https://medium.com/opendao/ravencoin-opendao-rvn-backed-stable-coin-7b4f15b47abb) for the OpenDAO team's writeup on this partnership.